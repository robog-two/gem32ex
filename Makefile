...
SRC = src/main.c src/ui/window.c src/ui/history.c src/ui/bookmarks.c src/ui/render.c src/network/http.c src/network/gemini.c src/network/loader.c $(CORE_SRC)
OBJ = $(SRC:.c=.o)
TARGET = gem32.exe
